...
@GenerateMocks(
  ...
  customMocks: [
    ...
    MockSpec<RentalService>(onMissingStub: OnMissingStub.returnDefault),
...
MockPusherService getAndRegisterPusherService() {
  _removeRegistrationIfExists<PusherService>();
  final service = MockPusherService();
  locator.registerSingleton<PusherService>(service);
  return service;
}

MockTournamentService getAndRegisterTournamentService() {
...
MockRentalService getAndRegisterRentalService() {
  _removeRegistrationIfExists<RentalService>();
  final service = MockRentalService();
  locator.registerSingleton<RentalService>(service);
  return service;
}
...
MockStartupService getAndRegisterStartupService() {
